...
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //   //   match password
    const passCheck = yield user_model_1.User.isPasswordMatch(password, isUserExist.password);
    ...
    const accessToken = jwtHelpers_1.jwtHelpers.createToken({ emailId }, config_1.default.jwt.token, config_1.default.jwt.token_expires);
    const refreshToken = jwtHelpers_1.jwtHelpers.createToken({ emailId }, config_1.default.jwt.refresh_token, config_1.default.jwt.refresh_expires_in);
