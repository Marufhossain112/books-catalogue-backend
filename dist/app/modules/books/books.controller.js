...
// add new book
const newBook = (0, catchAsynch_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
// get all books
const getAllBooks = (0, catchAsynch_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
// edit book
const editBook = (0, catchAsynch_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
...
// delete book
const deleteBook = (0, catchAsynch_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
